...
interface AnimatedGradientBackgroundProps {
  ...
  /**
   * Positioning class for the outer wrapper. Use to switch from absolute to sticky/fixed layouts.
...
const AnimatedGradientBackground: React.FC<AnimatedGradientBackgroundProps> = ({
  ...
  return (
    <motion.div
      ...
      className={`${positionClassName} overflow-hidden ${containerClassName}`}
    >
      <div
        ref={containerRef}
